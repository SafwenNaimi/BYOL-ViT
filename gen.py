...
class ResNetFeatures(nn.Module):
    ...
    def __init__(self):
        ...
        pretrained_path =  os.path.join('Python Scripts/VIT/new_byol_small.pth')
...
annotation_file = 'generocity_data.csv'
...
logs=os.path.join('Python Scripts/VIT/experiments/tb') #tboard
writer = SummaryWriter(logs + '/gen_byol' )
train_accs = []
test_accs = []
val=0
