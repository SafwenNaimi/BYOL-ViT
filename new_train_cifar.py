...
stl10 = torchvision.datasets.CIFAR10(root='Python Scripts/ViT/dataa', train=True, download=True, transform=train_transform)
dataloader_train = DataLoader(stl10, batch_size=16, num_workers=2, shuffle=True)
...
cifar10 = torchvision.datasets.CIFAR10(root='Python Scripts/ViT/dataa',train=False, download=True, transform=test_transform)
...
#logs=os.path.join('Python Scripts/VIT/experiments/exp2') #tboard
writer = SummaryWriter(logs + '/x_vit_byol_1000_cifar')
train_accs = []
test_accs = []
val=0
