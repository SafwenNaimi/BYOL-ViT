...
class ResNetFeatures(nn.Module):
    ...
    def __init__(self):
        ...
        pretrained_path =  os.path.join('Python Scripts/BYOL/experiments/self-supervised/cifar-10/cifar_bs16_Leaky_32100.pth')
...
model.load_state_dict(torch.load('Python Scripts/BYOL/experiments/supervised/cifar__.pth', map_location='cpu'))
...
writer = SummaryWriter(logs + '/vit_pretrained_cifar_100')
train_accs = []
test_accs = []
val=0
